<template>
    <div class="coin  w-14 h-14 md:w-20 md:h-20">
        <svg version="1.0" xmlns="http://www.w3.org/2000/svg" width="100%" height="100%"
            viewBox="30 0 200.000000 200.000000" preserveAspectRatio="xMidYMid meet">
            <g transform="translate(0.000000,200.000000) scale(0.100000,-0.100000)" fill="#fff"
                stroke="none">
                <circle cx="1261" cy="1006" r="945">
                </circle>

            </g>
            <g transform="translate(0.000000,200.000000) scale(0.100000,-0.100000)" v-bind:fill="fillColor" stroke="none">
...
15 -89 35 9 14 106 14 140 1z" />
            ...
            <g v-bind:fill="fillColor" stroke="none">
                <text letter-spacing="-0.5"  font-size="70" 
                     v-bind:x="(value==0.5 || value == 2.5)?80:105" y="122">
                    {{ value }} 
                </text>
            </g>
        </svg>
